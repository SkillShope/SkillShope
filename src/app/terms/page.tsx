  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-[var(--text-secondary)]">
        ...
        <section>
          <h2 className="mb-3 text-base font-semibold text-[var(--text)]">
            6. AI Estimates &amp; Voice Input
          </h2>
          <ul className="ml-4 list-disc space-y-2">
            <li>
              The AI Estimate Generator uses third-party AI services (Anthropic,
              OpenAI) to produce itemized estimates based on job descriptions and
              photos you provide. Estimates are generated by AI and are
              approximations only -- they are not professional quotes, bids, or
              guarantees of cost. Always verify materials, labor, and pricing
              before using an estimate with a client.
            </li>
            <li>
              The optional speech-to-text feature requires microphone access.
              By tapping &quot;Enable Mic&quot; or &quot;Speak,&quot; you consent
              to your device recording audio and transmitting it to our server for
              transcription via OpenAI. Audio is not stored after transcription.
              You may use the text input instead at any time.
            </li>
            <li>
              RoughInHub is not liable for any financial loss, project delays,
              or disputes arising from reliance on AI-generated estimates. Use
              them as a starting point, not a final quote.
            </li>
          </ul>
        </section>
        ...
        <section id="copyright">
          <h2 className="mb-3 text-base font-semibold text-[var(--text)]">
            9. User Content Disclaimer &amp; Copyright Policy
          </h2>
          <p className="mb-3">
